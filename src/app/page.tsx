  ...
  return (
    <main className="relative w-full bg-transparent selection:bg-brand-blue-100 selection:text-brand-blue-900">
      ...
      <div className="relative w-full">
        <SectionCard id="home" index={0} bgColor="bg-white/70 backdrop-blur-xl md:backdrop-blur-3xl">
          <Hero />
        </SectionCard>

        <SectionCard id="experience" index={1} bgColor="bg-slate-50/70 backdrop-blur-xl md:backdrop-blur-3xl">
          <TrustExperience />
        </SectionCard>

        <SectionCard id="services" index={2} bgColor="bg-slate-50/70 backdrop-blur-xl md:backdrop-blur-3xl">
          <ServicesTestimonials />
        </SectionCard>

          <SectionCard id="partnership" index={3} bgColor="bg-white/70 backdrop-blur-xl md:backdrop-blur-3xl">
          <AboutBooking />
          <Footer />
        </SectionCard>
      </div>
