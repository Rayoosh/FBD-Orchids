...
export function TrustExperience() {
  ...
  return (
    <section ref={containerRef} id="experience" className="py-12 md:py-32 bg-transparent overflow-hidden relative min-h-full flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-between gap-6 md:gap-12 mb-10 md:mb-48 border-y border-black/5 py-6 md:py-10">
          ...
          <div className="relative">
            <div className="md:sticky md:top-40">
              <Reveal>
                ...
                <TextReveal 
                  ...
                  className="text-4xl md:text-8xl font-serif text-slate-900 leading-[1.1] md:leading-[0.9] mb-4 md:mb-12 tracking-tighter premium-gradient-text"
                />
                
                <Reveal delay={0.4}>
                  <p className="text-lg md:text-xl text-slate-500 leading-relaxed max-w-md mb-6 md:mb-16 font-light">
            ...
            <div className="relative pt-6 md:pt-12">
              {/* Parallax Image Grid with Luxury Shadows */}
                <motion.div style={{ y: y1 }} className="mb-8 md:mb-24">
                  <ImageReveal 
                ...
                <motion.div
                  style={{ y: y2 }}
                  className="mt-6 lg:mt-0 lg:absolute -left-32 top-1/3 w-full lg:w-[110%] bg-transparent md:bg-white p-0 md:p-12 lg:p-16 flex flex-col justify-center rounded-none md:rounded-[2.5rem] md:luxury-shadow z-20 border-none md:border md:border-black/5"
                >
              ...
              <div className="mt-8 md:mt-64 lg:ml-auto max-w-sm text-right">
                <Reveal delay={0.6}>
