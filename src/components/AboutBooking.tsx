...
export function AboutBooking() {
    return (
      <section id="experience" className="py-40 md:py-60 bg-[#fbfbfd] overflow-hidden relative">
        {/* Subtle Glows */}
          ...
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-32 items-center mb-72">
            <div className="relative order-2 lg:order-1">
              <motion.div
                ...
                className="relative aspect-[4/5] rounded-3xl overflow-hidden editorial-shadow group"
              >
                <motion.img
                  initial={{ scale: 1.1 }}
                  whileInView={{ scale: 1 }}
              ...
              <motion.div 
                ...
                className="absolute -bottom-16 -right-16 bg-white p-12 luxury-shadow rounded-2xl hidden md:block border border-black/5"
              >
            ...
            >
              ...
              <h3 className="text-6xl md:text-8xl font-serif text-slate-900 leading-[0.85] mb-12 tracking-tighter">
                Ethics <br />
                <span className="italic text-slate-400 font-light pl-12">Meets Artistry.</span>
              </h3>
